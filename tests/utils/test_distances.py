...
def test_z_matter_radiation_equality():
    ...
    assert got.value == pytest.approx(3386.8453)
...
class Test_DistanceMeasureConverter:
    ...
    def test_a_of_rho(self, converter):
        ...
        # Edge cases
        assert converter.a_of_rho(1 / sqrt(2)).value == pytest.approx(0)

        # Consistency
        assert converter.a_of_rho(converter.rho_today).value == pytest.approx(
        ...
        assert converter.a_of_rho(converter.rho_begin).value == pytest.approx(
    ...
    def test_rho_of_a(self, converter):
        ...
        # Edge cases
        assert converter.rho_of_a(1).value == pytest.approx(41.16336547)
        assert converter.rho_of_a(0).value == pytest.approx(1 / sqrt(2))
        ...
        assert converter.rho_of_a(converter.a_begin).value == pytest.approx(
    ...
    def test_rho_of_z(self, converter):
        ...
        # Edge cases
        assert converter.rho_of_z(0).value == pytest.approx(41.16336547)
        assert converter.rho_of_z(inf).value == pytest.approx(1 / sqrt(2))
        ...
        assert converter.rho_of_z(converter.z_begin).value == pytest.approx(
            converter.rho_begin.value,
        )
    ...
    def test_z_of_rho(self, converter):
        ...
        # Consistency
        assert converter.z_of_rho(converter.rho_today).value == pytest.approx(
